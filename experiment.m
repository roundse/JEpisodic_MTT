...
EXT_CONNECT = .08;                   % Chance of connection = 20%
INT_CONNECT = .2;
...
w_food_to_hpc = 0.15 .* (rand(FOOD_CELLS, HPC_SIZE) < EXT_CONNECT);
w_hpc_to_food = - w_food_to_hpc';
w_place_to_hpc = 0.15 .* (rand(PLACE_CELLS, HPC_SIZE) < EXT_CONNECT);
